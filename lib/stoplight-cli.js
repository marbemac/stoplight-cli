  ...
  request(options, function(error, response, body) {
    ...
    if (!environment.url) {
      ...
      prompt.get(schema, function (err, result) {
        ...
        request(options, function(error, response, body) {
          console.log("Saved! You can always change this URL at https://app.stoplight.io.".green);
...
var setApp = function(authToken) {
  ...
  request(options, function(error, response, body) {
    ...
    if (!body.response.apps || body.response.apps.length == 0) {
      console.log("You have not created any apps yet. Please login at https://app.stoplight.io and create one. After you\'ve done that, run 'stoplight app' to connect to the app.".red);
      return;
    }
...
program
  ...
  .action(function() {
    ...
    console.log('Your authToken can be found by signing in at https://app.stoplight.io and clicking your name in the top right.'.yellow)
